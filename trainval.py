...
if __name__ == '__main__':
    ...
    # The predicted endpoint can be generated in advance
    if not (os.path.exists(file_path)):
        goal_estimator(test_set_name, trainer.dataloader) # Use goal estimator to get the predicted endpoint in advance
